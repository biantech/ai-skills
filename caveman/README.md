...
Ultra-compressed communication mode for Codex. Cuts token usage ~75% by dropping linguistic fluff while preserving full technical accuracy.
...
`SKILL.md` — loaded by Codex at runtime to apply caveman rules.
